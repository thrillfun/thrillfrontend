...
class PaymentRequest extends StatefulWidget {
  ...
  static Route route(List<WalletBalance> listBalance) {
    return MaterialPageRoute(
      ...
      builder: (context) => PaymentRequest(balanceList:listBalance,),
    );
  }
}
                      ...
                      children: [
                        RichText(
                            ...
                            text: TextSpan(children: [
                              ...
                              TextSpan(text: getAvailableAmount(), style: const TextStyle(fontWeight: FontWeight.bold))
                            ])
                        ),
                        RichText(
                          textAlign: TextAlign.center,
                            text: TextSpan(children: [
                              const TextSpan(text: "24h Withdrawal Limit\n\n"),
                              TextSpan(text: "${netList?.first.maxAmount} ${model?.code}", style: const TextStyle(fontWeight: FontWeight.bold))
                            ])
                        ),
                      ],
                    )
