        ...
        floatingActionButton: GradientElevatedButton(
            onPressed: () async {
              ...
              if (result != null) {
                ...
                if (size < 101) {
                  if (size > 0.1) {
                    AddSoundModel addSoundModel = AddSoundModel(
                        0, userModel.id, 0, file.path, name, '', '', true);
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  GestureDetector(
                                    onTap: () async {
                                      if (favSound
                                          .contains(newSongList[index])) {
                                        setState(() => favSound
                                            .remove(newSongList[index]));
                                        await RestApi
                                            .addAndRemoveFavariteSoundHastag(
                                                newSongList[index].id,
                                                "sound",
                                                0);
                                      } else {
                                        setState(() =>
                                            favSound.add(newSongList[index]));
                                        await RestApi
                                            .addAndRemoveFavariteSoundHastag(
                                                newSongList[index].id,
                                                "sound",
