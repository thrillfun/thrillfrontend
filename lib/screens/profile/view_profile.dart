...
class _ViewProfileState extends State<ViewProfile> {
  ...
  void initState() {
    ...
    getUserPublicVideos(
        widget.mapData["getProfile"] ? widget.mapData["id"] : userModel?.id);
    getUserLikedVideos(
        widget.mapData["getProfile"] ? widget.mapData["id"] : userModel?.id);
    try {
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: CachedNetworkImage(
                        fit: BoxFit.cover,
                        imageUrl: userModel!.avatar.isEmpty
                      ...
                      children: [
                        ...
                        RichText(
                            ...
                            text: TextSpan(children: [
                              TextSpan(
                                  text:
                                      '${userModel!.likes.isEmpty ? 0 : userModel!.likes}'
                                      '\n',
                                  style: const TextStyle(
                                      color: Colors.black, fontSize: 17)),
                              const TextSpan(
                        ...
                        GestureDetector(
                          onTap: () async {
                            ...
                            if (followList.contains(userModel?.id.toString())) {
                              ...
                              userModel?.followers =
                                  "${int.parse(userModel!.followers) - 1}";
                              if (int.parse(userModel!.followers) < 0)
                          ...
                          child: Material(
                            ...
                            child: Container(
                                ...
                                child: SizedBox(
                                  height: 10,
                                  child: followList
                                          .contains(userModel?.id.toString())
                                      ? const Icon(
                                        ...
                                        Container(
                                            ...
                                            child: ClipOval(
                                              child: CachedNetworkImage(
                                                ...
                                                imageUrl:
                                                    '${RestUrl.profileUrl}${followerModelList[index].image}',
                                                placeholder: (a, b) =>
                                                    const Center(
                                                  child:
  ...
  getFollowers() async {
    try {
      controller.getFollowers(userModel!.id);
      controller.followersModel.data!.forEach((element) {
        followerModelList.add(FollowerModel(element.id!, element.coverImage!,
            element.name!, element.email!, element.createdAt!));
      });
  ...
  feed() {
    return Obx(() => controller.isLoading.value ? const Center(child: CircularProgressIndicator(),):Flexible(
      child: GridView.builder(
          ...
          const SliverGridDelegateWithFixedCrossAxisCount(
              ...
              mainAxisSpacing: 1.8),
          itemCount: controller.userVideosModel.data!.length,
          itemBuilder: (BuildContext context, int index) {
            return GestureDetector(
              onTap: () {
//                Get.to(Home(vModel: controller.videoModel));
                Navigator.pushNamedAndRemoveUntil(
                    context, '/', (route) => true,
                    arguments: {'videoModel':  controller.userVideosModel.data![index]});
              },
              child: Stack(
                fit: StackFit.expand,
                children: [
                  ...
                  imgNet(
                      '${RestUrl.gifUrl}${ controller.userVideosModel.data![index].gifImage}'),
                  Positioned(
                      bottom: 5,
                      left: 5,
                      right: 5,
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            controller.userVideosModel.data![index].views.toString(),
                            style: const TextStyle(
                          ...
                          Text(
                            controller.userVideosModel.data![index].likes.toString(),
                            style: const TextStyle(
                                color: Colors.white, fontSize: 13),
                          ),
                        ],
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return GestureDetector(
                        onTap: () {
                          Navigator.pushNamedAndRemoveUntil(
                              context, '/', (route) => true,
                              arguments: {'videoModel': favVideos[index]});
                        },
                        child: Stack(
                          fit: StackFit.expand,
                          children: [
  ...
  getUserPublicVideos(int userID) async {
    try {
      controller.getUserPublicVideos(userID);
