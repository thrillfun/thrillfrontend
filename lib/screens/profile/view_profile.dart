...
class ViewProfile extends StatelessWidget {
  ...
  UserModel userModel = UserModel.fromJson(GetStorage().read("user"));
  ...
  Widget build(BuildContext context) {
    ...
    return GetX<UserController>(
        builder: (user) => user.isProfileLoading.value || user.isFollowingLoading.value|| user.isProfileLoading.value
            ? Scaffold(
                body: Container(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Visibility(
                                  visible: user.userProfile.value.data!.user?.isVerified=='true',
                                    child: SvgPicture.asset(
                                  'assets/verified.svg',
                                ))
                              ],
  ...
  feed() {
    return  GetX<VideosController>(builder: (videosController)=>videosController.videosLoading.value?const Flexible(child: Center(child: CircularProgressIndicator(),)):Flexible(
