...
class _PaymentHistoryState extends State<PaymentHistory> {
  ...
  List<PaymentHistoryModel> paymentHistoryList =
      List<PaymentHistoryModel>.empty(growable: true);
  bool isLoading = true;
                              ...
                              children: [
                                    ...
                                    Expanded(
                                      child: RichText(
                                        text: TextSpan(children: [
                                          TextSpan(
                                              text: paymentHistoryList[index]
                                                  .transactionStatus,
                                              style: TextStyle(
                                                  fontWeight: FontWeight.bold,
                                                  fontSize: 17,
                                                  color: paymentHistoryList[
                                                                  index]
                                                              .transactionStatus ==
                                                          "Pending"
                                                      ? Colors.blue
                                ...
                                SelectableText(
                                  paymentHistoryList[index]
                                          ...
                                          .isEmpty
                                      ? ""
                                      : "Tx: ${paymentHistoryList[index].transaction_id}",
                                  maxLines: 1,
                                )
                              ],
                            ),
  ...
  getPaymentHistory() async {
    try {
      ...
      paymentHistoryList =
          jsonList.map((e) => PaymentHistoryModel.fromJson(e)).toList();
      isLoading = false;
      setState(() {});
    } catch (e) {
