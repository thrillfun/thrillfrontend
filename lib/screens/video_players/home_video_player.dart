...
class HomeVideoPlayer extends GetView<RelatedVideosController> {
          ...
          (state) => PageView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return Stack(
                  children: [
                    GestureDetector(
                      onTap: ()=>betterPlayerController.setVolume(0),
                                    ...
                                    child: Column(
                                      children: [
                                        LikeButton(
                                          ...
                                          countBuilder:
                                              (int? count, bool isLiked,
                                              String text) {
                                            var color =
                                            isLiked ? Colors.white : Colors
                                                .white;
                                            Widget result;
                                            if (count == 0) {
                                              result = Text(
                                    ...
                                    onTap: () =>
                                        Get.to(SoundDetails(
                                          map: {
                                            ...
                                            "id": state[index].id,
                                            "profile": state[index].user!
                                                .avatar,
                                            "name": state[index].user!.name,
                                            "sound_id": state[index].soundId,
                                            "username": state[index].user!
                                                .username,
                                            "isFollow": state[index].user!
                                                .isFollow,
                                            "userProfile": state[index].user!
                                                .avatar != null
                                                ? state[index].user!.avatar
                                                : RestUrl.placeholderImage
                                          },
