class SearchHashtagModel {
  ...
  SearchHashtagModel({this.status, this.message, this.data});

  SearchHashtagModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class SearchList {
  ...
  SearchList({this.id, this.name, this.videos, this.videoCount});
