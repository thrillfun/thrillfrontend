class FollowingVideoModel {
  bool? status;
  String? message;
  List<FollowingVideos>? data;
  bool? error;

  FollowingVideoModel({this.status, this.message, this.data, this.error});

  FollowingVideoModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    if (json['data'] != null) {
      data = <FollowingVideos>[];
      json['data'].forEach((v) {
        data!.add(new FollowingVideos.fromJson(v));
      });
    }
    error = json['error'];
  }
...
class FollowingVideos {
  ...
  FollowingVideos.fromJson(Map<String, dynamic> json) {
    ...
    user = json['user'] != null ? new FollowingUser.fromJson(json['user']) : null;
  }
...
class PublicLevels {
  ...
  PublicLevels({this.current, this.next, this.progress});

  PublicLevels.fromJson(Map<String, dynamic> json) {
