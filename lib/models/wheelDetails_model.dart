...
class WheelDetails {
  ...
  WheelDetails(this.used_chance, this.available_chance, this.wheelRewards,
      this.recentRewards, this.last_reward);
  ...
  factory WheelDetails.fromJson(dynamic json) {
    ...
    List<RecentRewards> recentRewards =
        List<RecentRewards>.empty(growable: true);
    List jsonRecentList = json['recent_rewards'] as List;
    recentRewards =
        jsonRecentList.map((e) => RecentRewards.fromJson(e)).toList();
