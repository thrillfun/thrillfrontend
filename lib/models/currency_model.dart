class CurrencyModel {
  ...
  CurrencyModel(this.id, this.isActive, this.code, this.symbol, this.image,
      this.networks);
...
class Networks {
  ...
  Networks(this.id, this.currencyId, this.networkName, this.minAmount,
      this.maxAmount, this.feeDigit);
