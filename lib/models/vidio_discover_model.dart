...
class DiscoverVideo {
  ...
  factory DiscoverVideo.fromJson(dynamic json) {
    ...
    return DiscoverVideo(json['hashtag_id'] ?? 0, json['video_count'] ?? 0,
        json['hashtag_name'] ?? '', videoList, videoModelList);
  }
}
...
class HashVideo {
  ...
  HashVideo(this.id, this.user_id, this.video, this.video_thumbnail,
      this.gif_image, this.views, this.likes);
