class SafetyPreference {
  String whoCanSendDirectMessages, whoCanDuet, whoCanViewLikeVideos, whoCanCommentOnYourVideos, allowVideoToBeDownloaded;
  ...
  factory SafetyPreference.fromJson(dynamic json) {
    return SafetyPreference(
      ...
      allowVideoToBeDownloaded: json['safety_pref_allow_video_download'] ?? "OFF"
    );
  }
}
