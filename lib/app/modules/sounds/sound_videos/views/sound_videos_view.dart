...
import 'package:thrill/app/rest/models/videos_by_sound_model.dart';
...
class SoundVideosView extends GetView<SoundVideosController> {
...
class SoundVideos extends StatefulWidget {
  SoundVideos(
      {this.videoUrl,
      this.pageController,
      this.nextPage,
  ...
  @override
  State<SoundVideos> createState() => _SoundVideosState();
}

class _SoundVideosState extends State<SoundVideos>
    with SingleTickerProviderStateMixin {
  late VideoPlayerController videoPlayerController;
  var relatedVideosController = Get.find<SoundVideosController>();
                                                  ...
                                                  Get.defaultDialog(
                                                      ...
                                                      confirm: InkWell(
                                                        ...
                                                        onTap: () => relatedVideosController
                                                            .deleteUserVideo(
                                                                widget.videoId!)
                                                            .then((value) => relatedVideosController
                                                                .refereshVideos(
                                                                    Get.arguments[
                                                                        "sound_name"])
                                                                .then((value) =>
                            ...
                            children: [
                              Container(
                                ...
                                child: CachedNetworkImage(
                                  ...
                                  imageUrl: widget.publicUser == null ||
                                          widget.publicUser!.avatar == null ||
                                ...
                                itemBuilder: (context, index) => InkWell(
                                      onTap: () async {
                                        ...
                                        Get.toNamed(Routes.HASH_TAGS_DETAILS,
                                            arguments: {
                                              "hashtag_name":
                                                  "${widget.hashtagsList![index].name ?? widget.hashtagsList![index].hashtag!.name}",
                                              "hashtagId": widget
                                                  .hashtagsList![index]
                                                  .hashtag!
                                                  .id
...
class SoundCommentsView extends GetView<CommentsController> {
  SoundCommentsView(
      {Key? key,
      this.videoId,
      this.userId,
