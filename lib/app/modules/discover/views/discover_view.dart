                    ...
                    NotificationListener<ScrollEndNotification>(
                        onNotification: (scrollNotification) {
                          if (scrollNotification.metrics.pixels ==
                            ...
                            controller.getPaginationHashtags();
                          }
                          return true;
                        },
                              ...
                              child:
                                ...
                                child: ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      state[index].videos!.removeWhere(
                                          (element) => element.id == null);
                                      return Visibility(
                                          visible:
                                              state[index].videos!.isNotEmpty,
                                          child: Column(
                                            children: [
                                              InkWell(
                                                onTap: () async {
                                                                              ...
                                                                              RichText(
                                                                                text: TextSpan(
                                                                                  children: [
                                                                                    ...
                                                                                    TextSpan(text: " " + NumberFormat.compact().format(state[index].videos![videoIndex].views ?? 0).toString(), style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 14)),
                                                                                  ],
                                                                                ),
                                                                              )
                                                                            ],
