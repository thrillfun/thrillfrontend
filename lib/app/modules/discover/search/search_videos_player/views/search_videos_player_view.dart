...
class SearchVideosPlayerView extends GetView<SearchVideosPlayerController> {
  const SearchVideosPlayerView({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: PageView.builder(
        itemCount: (Get.arguments["search_videos"] as List<VideosList>).length,
          ...
          return Stack(children: [InkWell(
            ...
            child: BetterPlayerListVideoPlayer(
              BetterPlayerDataSource.network(RestUrl.videoUrl +
                  (Get.arguments["search_videos"] as List<VideosList>)[index].video!),
                      ...
                      children: [
                        LikeButton(
                            ...
                            likeBuilder: (bool isLiked) {
                              (Get.arguments["search_videos"] as List<VideosList>)[index].videoLikeStatus == 0
                                  ? isLiked = false
                                  : isLiked = true;
                              return Icon(
                                isLiked
                            ...
                            likeCount: (Get.arguments["search_videos"] as List<VideosList>)[index].videoLikeStatus,
                            countBuilder:
                            ...
                            onTap: (_) async {
                              controller.likeVideo(
                                  (Get.arguments["search_videos"] as List<VideosList>)[index].videoLikeStatus == 0
                                      ? 1
                                      : 0,
                                  (Get.arguments["search_videos"] as List<VideosList>)[index].id!,
                                  token: (Get.arguments["search_videos"] as List<VideosList>)[index].user!.firebaseToken);
                            }),
                      ],
                    ),
                  ),
                  Container(
                    ...
                    child: Column(
                      children: [
                            ...
                            onPressed: () async {
                              commentsController
                                ...
                                Get.bottomSheet(CommentsView(
                                    videoId: (Get.arguments["search_videos"] as List<VideosList>)[index].id,
                                    userId: (Get.arguments["search_videos"] as List<VideosList>)[index].user!.id,
                                    isCommentAllowed:
                                    true.obs,
                                    // (Get.arguments["search_videos"] as List<VideosList>)[index].isCommentable ==
                                    //     "Yes"
                                    //     ? true.obs
                                    //     : false.obs
                                    isfollow: int.parse((Get.arguments["search_videos"] as List<VideosList>)[index].user!.following
                                        .toString()),
                        ...
                        Text(
                          (Get.arguments["search_videos"] as List<VideosList>)[index].comments != null
                              ? "${(Get.arguments["search_videos"] as List<VideosList>)[index].comments}"
                              : "0",
                                              ...
                                              child: Column(
                                                children: [
                                                  IconButton(
                                                      onPressed:
                                                          () async {
                                                        if ((Get.arguments["search_videos"] as List<VideosList>)[index]
                                                            .user!.id ==
                                                            GetStorage()
                                                                .read(
                                                                "userId")) {
                                                          Get
                                                              ...
                                                              InkWell(
                                                                ...
                                                                onTap: () =>
                                                                    controller
                                                                        .deleteUserVideo(
                                                                        (Get.arguments["search_videos"] as List<VideosList>)[index]
                                                                            .user!
                                                                            .id!)
                                                                        .then((
                                                                        value) =>
                                                      ...
                                                      icon: (Get.arguments["search_videos"] as List<VideosList>)[index]
                                                          .user!.id
                                                          ==
                                                          GetStorage()
                                                              .read(
                                              ...
                                              onTap: () async {
                                                if (await GetStorage()
                                                  ...
                                                  controller
                                                      ...
                                                      (Get.arguments["search_videos"] as List<VideosList>)[index]
                                                          .user!.id!,
                                                      int.parse((Get.arguments["search_videos"] as List<VideosList>)[index]
                                                          .user!.following
                                                          .toString()) ==
                                                          0
                                                          ? "follow"
              ...
              child: Column(
                ...
                children: [
                  GestureDetector(
                    onTap: () async {
                      if (await GetStorage().read("token") == null) {
                        ...
                        if ((Get.arguments["search_videos"] as List<VideosList>)[index].user!.id ==
                            GetStorage().read("userId")) {
                          Get.toNamed(Routes.PROFILE);
                        }
                        else {
                          Get.toNamed(Routes.OTHERS_PROFILE, arguments: {
                            "profileId": (Get.arguments["search_videos"] as List<VideosList>)[index].user!.id
                          });
                        }
                      }
                    },
                      ...
                      children: [
                        Container(
                          ...
                          child: CachedNetworkImage(
                            ...
                            imageUrl: (Get.arguments["search_videos"] as List<VideosList>)[index].user!.avatar == null ||
                                (Get.arguments["search_videos"] as List<VideosList>)[index].user!.avatar!.isEmpty
                                ? RestUrl.placeholderImage
                                : RestUrl.profileUrl +
                                (Get.arguments["search_videos"] as List<VideosList>)[index].user!.avatar.toString(),
                            fit: BoxFit.fill,
                          ),
                        ),
                        const SizedBox(
                        ...
                        Column(
                          ...
                          children: [
                            Row(
                              children: [
                                Text(
                                  (Get.arguments["search_videos"] as List<VideosList>)[index].user!.username ?? "",
                                  style: const TextStyle(
                                      color: Colors.white,
                                      fontSize: 18,
                                  ...
                                  child: InkWell(
                                      onTap: () async {
                                        if (await GetStorage()
                                          ...
                                          controller
                                              .followUnfollowUser(
                                            (Get.arguments["search_videos"] as List<VideosList>)[index].user!.id!,
                                            int.parse((Get.arguments["search_videos"] as List<VideosList>)[index].user!
                            ...
                            Text(
                              (Get.arguments["search_videos"] as List<VideosList>)[index].user!.name ?? "",
                              style: const TextStyle(
                                  color: Colors.white,
                                  fontSize: 14,
                  ...
                  Padding(
                    ...
                    child: Text(
                      (Get.arguments["search_videos"] as List<VideosList>)[index].description.toString(),
                      style: const TextStyle(
                          color: Colors.white,
                          fontSize: 14,
                  ...
                  Visibility(
                    visible: (Get.arguments["search_videos"] as List<VideosList>)[index].hashtags!=null,
                    child: Container(
                      height: 35,
                      margin: const EdgeInsets.symmetric(horizontal: 10),
                      child: ListView.builder(
                          itemCount: (Get.arguments["search_videos"] as List<VideosList>)[index].hashtags?.length,
                          shrinkWrap: true,
                  ...
                  GestureDetector(
                    onTap: () async {
                      await GetStorage()
                          .write("profileId", (Get.arguments["search_videos"] as List<VideosList>)[index].user!.id);

                      Get.toNamed(Routes.SOUNDS, arguments: {
                        "sound_name": (Get.arguments["search_videos"] as List<VideosList>)[index].soundName.toString(),
                        "sound_url": (Get.arguments["search_videos"] as List<VideosList>)[index].sound,
                      });
                    },
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          (Get.arguments["search_videos"] as List<VideosList>)[index].soundName!.isEmpty
                              ? "Original Sound"
                              : (Get.arguments["search_videos"] as List<VideosList>)[index].soundName! +
                              " by ${(Get.arguments["search_videos"] as List<VideosList>)[index].user!.name}",
