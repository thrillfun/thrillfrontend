              ...
              children: [
                ...
                child: BetterPlayerListVideoPlayer(
                  BetterPlayerDataSource.network(RestUrl.videoUrl +
                      (Get.arguments["discover_videos"] as List<Videos>)[index]
                          .video!),
                          ...
                          children: [
                            LikeButton(
                                ...
                                likeBuilder: (bool isLiked) {
                                  (Get.arguments["discover_videos"] as List<
                                      Videos>)[index].videoLikeStatus == 0
                                      ? isLiked = false
                                      : isLiked = true;
                                  return Icon(
                                    isLiked
                                ...
                                onTap: (_) async {
                                  controller.likeVideo(
                                      ...
                                      token: (Get
                                          .arguments["discover_videos"] as List<
                                          Videos>)[index].user!.firebaseToken);
                                }),
                          ],
                        ),
                      ),
                                ...
                                onPressed: () async {
                                  commentsController
                                    ...
                                    Get.bottomSheet(CommentsView(
                                        ...
                                        userId: (Get
                                            .arguments["discover_videos"] as List<
                                            Videos>)[index].user!.id,
                                        isCommentAllowed:
                                        (Get
                                            .arguments["discover_videos"] as List<
                                            Videos>)[index].isCommentable ==
                                            "Yes"
                                            ? true.obs
                                            : false.obs,
                                        isfollow: int.parse((Get
                                            .arguments["discover_videos"] as List<
                                            Videos>)[index].user!.following
                                            .toString()),
                                        userName: (Get
                                            .arguments["discover_videos"] as List<
                                            Videos>)[index].user!.username,
                                        avatar: (Get
                                            .arguments["discover_videos"] as List<
                                            Videos>)[index].user!.avatar ?? "",
                                        fcmToken: (Get
                                            .arguments["discover_videos"] as List<
                                            Videos>)[index].user!
                  ...
                  child: Column(
                    ...
                    children: [
                      GestureDetector(
                        onTap: () async {
                          if (await GetStorage().read("token") == null) {
                            ...
                            if ((Get.arguments["discover_videos"] as List<
                                Videos>)[index].user!.id ==
                          ...
                          children: [
                            Container(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl: (Get
                                    .arguments["discover_videos"] as List<
                                    Videos>)[index].user!.avatar == null ||
                                    (Get.arguments["discover_videos"] as List<
                                        Videos>)[index].user!.avatar!.isEmpty
                                    ? RestUrl.placeholderImage
                                    : RestUrl.profileUrl +
                                    (Get.arguments["discover_videos"] as List<
                                        Videos>)[index].user!.avatar.toString(),
                                fit: BoxFit.fill,
                              ),
                            ),
                            const SizedBox(
                      ...
                      Padding(
                        ...
                        child: Text(
                          (Get.arguments["discover_videos"] as List<
                              Videos>)[index].description.toString(),
                          style: const TextStyle(
                              color: Colors.white,
                              fontSize: 14,
                      ...
                      Visibility(
                        visible: (Get.arguments["discover_videos"] as List<
                            Videos>)[index].hashtags!.isNotEmpty,
                        child: Container(
                          height: 35,
                      ...
                      GestureDetector(
                        onTap: () async {
                          ...
                          Get.toNamed(Routes.SOUNDS, arguments: {
                            "sound_name": (Get
                                .arguments["discover_videos"] as List<
                                Videos>)[index].soundName.toString(),
                            "sound_url": (Get
                                .arguments["discover_videos"] as List<
                                Videos>)[index].sound,
                          });
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              (Get.arguments["discover_videos"] as List<
                                  Videos>)[index].soundName!.isEmpty
                                  ? "Original Sound"
                                  : (Get.arguments["discover_videos"] as List<
                                  Videos>)[index].soundName! +
                                  " by ${(Get
                                      .arguments["discover_videos"] as List<
                                      Videos>)[index].user!.name}",
