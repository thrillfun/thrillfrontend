          ...
          (state) => PageView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return DiscoverVideos(
                  ...
                  isfollow: state[index].user!.isfollow, //state[index].isfollow
...
class DiscoverVideos extends StatefulWidget {
  ...
  @override
  State<DiscoverVideos> createState() => _DiscoverVideosState();
}

class _DiscoverVideosState extends State<DiscoverVideos>
    with SingleTickerProviderStateMixin {
  late VideoPlayerController videoPlayerController;
  var relatedVideosController = Get.find<DiscoverVideoPlayerController>();
...
class DiscoverCommentsView extends GetView<CommentsController> {
  DiscoverCommentsView(
      {Key? key,
      this.videoId,
      this.userId,
      this.isCommentAllowed,
