...
class HashTagsVideoPlayerView extends GetView<HashTagsVideoPlayerController> {
  HashTagsVideoPlayerView({Key? key}) : super(key: key);
...
class HashtagVideos extends StatefulWidget {
  HashtagVideos(
      {this.videoUrl,
      this.pageController,
      this.nextPage,
  ...
  @override
  State<HashtagVideos> createState() => _HashtagVideosState();
}

class _HashtagVideosState extends State<HashtagVideos>
    with SingleTickerProviderStateMixin {
  late VideoPlayerController videoPlayerController;
  var relatedVideosController = Get.find<HashTagsVideoPlayerController>();
...
class HashtagCommentsView extends GetView<CommentsController> {
  HashtagCommentsView(
      {Key? key,
      this.videoId,
      this.userId,
