            ...
            Expanded(
                child: DefaultTabController(
                    ...
                    child: Scaffold(
                      ...
                      body: TabBarView(children: [UserVideosView(),UserPrivateVideosView(),UserLikedVideosView()]),
                    )))
          ]),
        ));
  }
              ...
              children: [
                GestureDetector(
                  onTap: () {
                    ...
                    //     true.obs, state.value.id!.obs))));
                      Get.toNamed(Routes.USERS_FOLLOWING,arguments: {"index":0});
                ...
                GestureDetector(
                  onTap: () {
                    ...
                    //     .then((value) => Get.to(FollowingAndFollowers(
                    //     true.obs, state.value.id!.obs))));
                    Get.toNamed(Routes.USERS_FOLLOWING,arguments: {"index":1});
