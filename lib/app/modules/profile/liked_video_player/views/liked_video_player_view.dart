...
import 'package:thrill/app/modules/related_videos/views/related_videos_view.dart';
    ...
    return Scaffold(
      body: controller.obx(
          ...
          onEmpty: NoSearchResult(
            text: "Whenever you will like any videos. they will show up here",
          )),
    );
  }
...
class _LikedVideosState extends State<LikedVideos>
  ...
  var relatedVideosController = Get.find<LikedVideoPlayerController>();
                                                                      ...
                                                                      if (widget
                                                                        ...
                                                                        Get.defaultDialog(
                                                                            ...
                                                                            confirm: InkWell(
                                                                              ...
                                                                              onTap: () => relatedVideosController.deleteUserVideo(widget.videoId!).then((value) => relatedVideosController.getUserLikedVideos().then((value) => Get.back())),
                                                                            ),
                                                                            cancel: InkWell(
                                                                              child: Container(
                                                                                width: Get.width,
                                                                    ...
                                                                    onPressed:
                                                                      ...
                                                                      Clipboard.setData(ClipboardData(
                                                                          text: await relatedVideosController.createDynamicLink(
                                                                              widget.currentPageIndex!.value.toString(),
                                                                              "video",
                                                                              widget.userName.toString(),
                                                                              widget.avatar.toString())));
                                                            ...
                                                            await relatedVideosController
                                                                .checkUserBlocked(
                                                                    widget
                                                                        .UserId!)
                                                                .then((value) async =>
                                                                    await relatedVideosController.blockUnblockUser(
                                                                        widget
                                                                            .UserId!,
                                                                        value));
                                                          }
                                  ...
                                  if (await GetStorage().read("token") ==
                                    ...
                                    if (await Permission.phone.isGranted) {
                                      ...
                                      await Permission.phone.request().then(
                                          (value) async =>
                                              await SimDataPlugin.getSimData()
                                                  .then((value) => value
                                                          .cards.isEmpty
                                                      ? showLoginBottomSheet(
                                                          false.obs)
...
class LikedCommentsView extends GetView<CommentsController> {
  LikedCommentsView(
      {Key? key,
      this.videoId,
      this.userId,
