      ...
      body: Scaffold(
          ...
          appBar: AppBar(
            ...
            actions: [
              InkWell(
                  onTap: () async {
                    Share.share(await controller.createDynamicLink(
              ...
              Stack(
                children: [
                  ...
                  controller.obx(
                      ...
                      onLoading: otherUserProfileShimmer())
                ],
              ),
              Obx(() => Visibility(
                  visible: controller.isFollowingVisible.isTrue,
                  child: GetX<OthersProfileController>(
                      builder: (controller) => controller
                              .isSuggestedLoading.isTrue
                          ? loader()
                          : Container(
                              alignment: Alignment.centerLeft,
                                                ...
                                                children: [
                                                  Stack(
                                                    ...
                                                    children: [
                                                      ...
                                                      InkWell(
                                                        onTap: () => controller.followUnfollowTopUser(
                                                            controller
                                                                .searchList[0]
                                                                .users![index]
                                                                .id!,
