...
class OthersLikedVideosPlayerView
  ...
  OthersLikedVideosPlayerView({Key? key}) : super(key: key);
          ...
          (state) => LoopPageView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return OthersLikedVideos(
                  ...
                  isfollow: state[index].user!.isfollow!.obs,
...
class OthersLikedVideos extends StatefulWidget {
  OthersLikedVideos(
      {this.videoUrl,
      this.pageController,
      this.nextPage,
  ...
  @override
  State<OthersLikedVideos> createState() => _OthersLikedVideosState();
}

class _OthersLikedVideosState extends State<OthersLikedVideos>
    with SingleTickerProviderStateMixin {
  late VideoPlayerController videoPlayerController;
  var relatedVideosController = Get.find<OthersLikedVideosPlayerController>();
...
class OthersLikedCommentsView extends GetView<CommentsController> {
  OthersLikedCommentsView(
      {Key? key,
      this.videoId,
      this.userId,
      this.isCommentAllowed,
