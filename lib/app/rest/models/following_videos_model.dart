class FollowingVideosModel {
  ...
  FollowingVideosModel({this.status, this.message, this.data, this.error, this.pagination});

  FollowingVideosModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
