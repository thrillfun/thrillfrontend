...
import '../modules/camera/video_thumbnail/controllers/video_thumbnail_controller.dart';

class AudioTrimmerView extends StatefulWidget {
  final File file;
  int length =0;
  AudioTrimmerView(this.file, this.length,{Key? key}) : super(key: key);
  @override
                ...
                Center(
                  child: Padding(
                    ...
                    child: TrimViewer(
                      trimmer: _trimmer,
                      viewerHeight: 100,
                      viewerWidth: Get.height,
                      maxAudioLength: Duration(seconds:widget.length ),
